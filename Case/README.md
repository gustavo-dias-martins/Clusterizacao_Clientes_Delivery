# Case para Analista de Dados CRM - Delivery

## Texto de apresentação

A empresa é o aplicativo líder de entrega de alimentos no Brasil, presente em mais de mil cidades. 
...
Neste case, você recebe um conjunto de dados de amostra, que simula metainformações sobre o cliente e as interações da campanha da empresa com esse cliente.
...
Tenha foco claro em qual função você deseja executar na empresa e concentre sua energia para se destacar em tópicos mais relevantes para isso. 
